...
## What thickness actually is

Reinforced single-ply membranes (TPO, PVC) are a polymer sandwich around a fabric scrim.
...
| Criterion | 45 mil | 60 mil | 80 mil |
| --- | --- | --- | --- |
| Role | Economy / short horizon | Commercial default | Heavy traffic / long hold |
| Puncture resistance | Baseline | Meaningfully better | Best |
| Weathering reserve | Least | More | Most |
| Hail tolerance | Lowest | Better | Best |
...
4. **Warranty target.** Manufacturers commonly cap longer warranties to thicker sheets —
   sometimes the warranty term, not the physics, forces the spec.

## Common mistakes

1. Accepting bids at unstated thickness — the classic apples-to-oranges bid spread.
2. Buying 80 mil while skipping walkway pads at equipment (thickness treats the symptom).
3. Comparing thickness across chemistries as if mils were equivalent — a 60-mil EPDM,
   TPO, and PVC are different products; compare within chemistry.
